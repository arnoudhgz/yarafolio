...
5. Learn nudge: run `python3 scripts/learn_stats.py --count-only` and compare against the count in the latest LEARNINGS.md entry (0 if none). If 10+ new measurable outcomes, suggest `/learn` in one sentence. Never auto-run it.
