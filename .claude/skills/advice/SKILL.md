...
3. Specifically, use the exact scripts and tools mentioned in the `CLAUDE.md` file to fetch oversold candidates, perform deep dives, check red flags, and then log the picks.
