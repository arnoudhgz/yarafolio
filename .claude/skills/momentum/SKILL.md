...
Run `python3 scripts/screen.py momentum --min-rsi 70 --exclude-held --exclude-advised`. Ensure all candidates adhere to STRATEGY.md. You MUST strictly filter for A-rated candidates (A-, A, A+) only; reject all B-rated or lower momentum stocks due to historical underperformance.
