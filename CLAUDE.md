...
- Flag falling-knife and value-trap risks explicitly in the Rating or Risk column. Tech stocks have heavily underperformed; require exceptional setups for Tech or mark them high-risk. B and C rated stocks historically outperform A-rated stocks; do not overly penalize minor flaws if the oversold thesis is strong.
