...
4. Keep/drop check-in: Run `python3 scripts/advice_log.py checkin-candidates` and append the output to the end of your report for the user to review later. NEVER use an interactive question tool or pause execution to ask the user, as the `/advice` workflow must be 100% fire-and-forget.
