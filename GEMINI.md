...
`dashboard.html` is my visual view (start with `python3 serve.py`), a global search bar (ticker/name/reason/sector, filters whichever table tab is active) plus four tabs:
